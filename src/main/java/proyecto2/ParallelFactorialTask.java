...
public class ParallelFactorialTask implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("Fibonacci " + start + " to " + end + ", Time: " + formato1.format(time1) + " miliseconds");
    }
    ...
    public static BigInteger createAndExecuteThreads(int numTasks, BigInteger number){
        ...
        ParallelFactorialTask[] tasks = new ParallelFactorialTask[numTasks];
        ...
        for (int i = 0; i < numTasks; i++) {
            ...
            tasks[i] = new ParallelFactorialTask(start, end);
        ...
        for (int i = 0; i < numTasks; i++) {
            ...
            result = result.multiply(tasks[i].getResult());
        }
        timeData.end1 = Instant.now(); 
        double time1 = Duration.between(timeData.start1, timeData.end1).toNanos()*0.000001;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El factorial de " + number + " es: ");
